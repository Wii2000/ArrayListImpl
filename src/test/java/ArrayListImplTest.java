...
class ArrayListImplTest {
    ...
    void testCreateWithCollection() {
        ArrayListImpl<Boolean> list = new ArrayListImpl<>(List.of(true, false, true));
        Assertions.assertEquals(3, list.size());
    }

    @Test
    void testCreateWithZeroSizeCollection() {
        ArrayListImpl<Integer> list = new ArrayListImpl<>(List.of());
        Assertions.assertEquals(0, list.size());
    }
    ...
    @Test
    void testGet() {
        ArrayListImpl<String> list = new ArrayListImpl<>(List.of("One", "Two", "Three"));
